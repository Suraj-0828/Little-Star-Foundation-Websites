...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data .= '<tr><td>Full Address: </td><td>' . $_POST['address'] . '</td></tr>';
    $data .= '<tr><td>Occupation: </td><td>' . $_POST['occupation'] . '</td></tr>';
    ...
    $headers .= 'From: Contact Us <info@littlestarfoundation.in>' . "\r\n";
